...
export const Route = createFileRoute("/whatsapp")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Generate Bot WhatsApp Node.js + Baileys dengan menu, owner, admin, dan database." },
...
function WhatsappPage() {
  ...
  return (
    <AppShell>
      ...
      <p className="mt-1 text-sm text-muted-foreground">Project dihasilkan sebagai source code. Akun WhatsApp Anda tidak pernah dijalankan di server.</p>
      <div className="mt-6"><SiteBanner bannerType="whatsapp" /></div>
      <div className="mt-6">
        <BuilderForm
          ...
          extraFields={<div className="space-y-2"><Label>Nomor Owner</Label><Input value={owner} onChange={(e) => setOwner(e.target.value)} placeholder="6285769302532" /></div>}
          meta={{ owner }}
        />
      </div>
    </AppShell>
