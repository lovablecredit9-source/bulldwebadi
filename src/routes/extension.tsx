  ...
  head: () => ({
    meta: [
      { title: "Browser Extension Builder — ADI BUILDER BOT" },
      {
        name: "description",
        content:
          "Generate Chrome/Chromium Extension Manifest V3: popup, service worker, content script, options page.",
      },
  ...
  return (
    <AppShell>
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Selalu memakai Manifest V3 dengan permission seminimal mungkin.
      </p>
      <div className="mt-6">
        <BuilderForm
