...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return <div className="min-h-screen bg-background lg:grid lg:grid-cols-[260px_1fr]">
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1"><AppErrorBoundary>{children}</AppErrorBoundary>{workspaceMatch && <GenerateImagePanel projectId={workspaceMatch[1]} model="mk/auto" />}</main>
      <Footer />
    </div>
  </div>;
}
