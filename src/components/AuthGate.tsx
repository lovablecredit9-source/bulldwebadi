      ...
      <div className="w-full max-w-md rounded-3xl border bg-card p-6 shadow-sm sm:p-8">
        ...
        <form onSubmit={submit} className="mt-6 space-y-4">
          <div className="space-y-2">
            ...
            <Input id="auth-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="nama@email.com" autoComplete={mode === "login" ? "email" : "username"} disabled={loading} />
          </div>
          <div className="space-y-2">
